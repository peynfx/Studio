...
*** La variabile dell'inconscio
   ...
   Come in una variabile qualsiasi del nostro Java, se la cosidetta ha un valore non ne può aveere un altro.
   Perciò formalizzare in anticipo un pensiero, potrebbe equivalere a *dare un valore alla variabile* cosicchè  si disabiliti
   il riempimento automatico causato dall'inconscio. 
   
*** NEXT [#A] Pratica						    :Pratica:
...
Ctrl-C Ctrl C below to add keywords 
#+SEQ_TODO: NEXT(n) TODO(t) WAITING(w) SOMEDAY(s) | DONE(d) CANCELLED (c) 

* WAITING TODO  Ctrl-c Ctrl-t open TODO menu
  DEADLINE: <2018-02-27 mar> SCHEDULED: <2018-02-22 gio>

Ctrl-c Ctrl-c add tags

Ctrl-c Ctrl-w move outline to another outliner
